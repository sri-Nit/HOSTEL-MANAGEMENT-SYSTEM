...
const StudentDashboard: React.FC = () => {
  ...
  return (
    <div className="flex min-h-[calc(100vh-64px)]"> {/* Adjust min-h to account for Navbar height */}
      <Sidebar />
      <main className="flex-1 p-6 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300">
            Welcome, {user?.name}! Here you can view your submitted complaints and their statuses.
          </p>
